...
class Template {
    ...
    public static function searchOfferTemplate($offers, $mro) {
        Template::setHeader();
        echo '<table border="1" cellpadding="5" cellspacing="0" width="50%" rules="all">';
        echo '<tr bgcolor="#b0c4de">';
        echo '<th>Bild</th>';
        echo '<th>Ort</th>';
        echo '<th>Hotel</th>';
    ...
    public static function searchFlightsTemplate($flights, $mro) {
        ...
        for ($i = 0; $i < count($flightList); $i++) {
            ...
            echo '<td> <img src="http://web3.travel-it.com/static/images/va/SLR_35.png" alt="" border=3 height=100 width=100></td>';
